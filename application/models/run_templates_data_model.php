...
class Run_templates_data_model extends CI_Model {
    ...
    public function add() {
        $data = array('label' => $this->input->post('label'),
                      ...
                      'control_dat' => $this->input->post('control_dat'),
                      'experiment_data_dat' => $this->input->post('experiment_data_dat'),
                      'crop_data_dat' => $this->input->post('crop_data_dat'),
                      'reruns_dat' => $this->input->post('reruns_dat'),
                      'preset' => $this->input->post('preset')
    );

        $this->db->insert($this->RUN_TEMPLATES_DATA_TABLE, $data);
    }
